...
contract PuppyRaffle is ERC721, Ownable {
    ...
    //  @audit [me] - denial of service. AttackVector => if for loop iteration is high (almost infinite)
    ...
    //  @audit [me] (INFORMATIONAL) default `return 0` is deceptive for non active players
    //  @audit [me] denial of service as a result of higher for loop iterations
    ...
    function selectWinner() external {
        ...
        // @audit I-# magic numbers 80, 20 should be stored in a descriptive variable
        uint256 prizePool = (totalAmountCollected * 80) / 100;
        uint256 fee = (totalAmountCollected * 20) / 100;
        // @audit integer overflow as a result of casting
        ...
        // @audit case where winner (Smart Contract) has missing fallback payable function (receive),
    ...
    function withdrawFees() external {
        ...
        totalFees = 0;
        // @audit case where feeAddress is a contract having a broken fallback function, causes this to revert
